...
eval_cate_code = """# Đánh giá ĐỘC LẬP nhóm CATE > 0.75 (Nhóm 22 người "Hòa vốn" / "Có Lãi" duy nhất)
...
# Fix the bug: split on actual newline, then append actual newline.
clean_source_lines = [line + '\n' for line in eval_cate_code.split('\n')]
...
for cell in reversed(nb['cells']):
    if cell['cell_type'] == 'code':
        ...
        clean_source.extend(clean_source_lines)
