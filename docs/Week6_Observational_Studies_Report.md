...
- **Mỏ vàng thực sự:** Trái lại, nhóm khách hàng đi chơi nội thành (`Urban Credit Card`) thể hiện mức độ đàn hồi cực cao với giá cả. Voucher 25% đã kích hoạt sự bùng nổ nhu cầu (ATE = 2.5), mang lại mức ROI dương vượt trội (> 100%).
...
2. **Thực thi Mở rộng (Roll-out):** Thiết lập chiến dịch Marketing tự động phát hành Voucher 25% độc quyền cho nhóm `Urban Credit Card` vào các khung giờ thấp điểm.
