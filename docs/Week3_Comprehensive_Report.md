...
## Phần Phụ lục: Bản Đặc tả Chỉ số Đo lường (Metric Specification)
*Phần này đi sâu vào cách định nghĩa và công thức tính toán cho các chỉ số được đề cập ở mục 8.*
