...
2. **Kết quả Thực nghiệm (`y_rand`):** Số chuyến đi trong môi trường Thử nghiệm ngẫu nhiên có đối chứng (RCT). Tác động của Voucher không đồng nhất mà tuân theo **Hiệu ứng Dị thể (Heterogeneous Treatment Effect - HTE)**:\n   - **Nhóm Cầu không co giãn (Suburban Commuters):** Tác động thấp (ATE = 0.8 chuyến).\n   - **Nhóm Cầu co giãn cao (Urban Leisure):** Tác động cực kỳ mạnh mẽ (ATE = 2.5 chuyến).
