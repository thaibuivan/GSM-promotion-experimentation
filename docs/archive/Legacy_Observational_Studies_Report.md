# Báo cáo Đánh giá Thí nghiệm: Chiến dịch Khuyến mãi Voucher 15%

**Bối cảnh Dự án:** Đo lường tác động nhân quả (Causal Measurement) của Voucher giảm giá 15% lên mức độ tương tác của người dùng.
...
Một chiến dịch thử nghiệm ngẫu nhiên (A/B Testing) đã được tiến hành nhằm đánh giá tính khả thi và ROI của Voucher 15%. Trái với nhận định ban đầu, chiến dịch đã vạch trần một sự thật quan trọng về Hiệu ứng Dị thể (HTE):
...
- **Mỏ vàng thực sự:** Trái lại, nhóm khách hàng đi chơi nội thành (`Urban Credit Card`) thể hiện mức độ đàn hồi cực cao với giá cả. Voucher 15% đã kích hoạt sự bùng nổ nhu cầu (ATE = 2.5), mang lại mức ROI dương vượt trội (> 100%).
- **Khuyến nghị:** Dừng ngay lập tức chiến lược rải Voucher đại trà. Thay vào đó, áp dụng Uplift Modeling để tập trung toàn bộ ngân sách Marketing cho tập khách hàng `Urban Credit Card`.
...
- **Cluster 2 (Urban Credit Card):** Khách đi chơi nội thành giờ thấp điểm (Cầu co giãn siêu cao).
...
- **Nhóm Can thiệp (Treatment Group):** Nhận Voucher giảm giá 15%.
...
- **Nhóm Suburban Commuters:** Mặc dù số chuyến đi có tăng nhẹ (p < 0.05), nhưng mức tăng (+0.84 chuyến) là quá nhỏ. Việc trợ giá 15% cho một nhóm vốn đã đi xe thường xuyên dẫn đến hiệu ứng Bào mòn Lợi nhuận (Cannibalization).
- **Nhóm Urban Credit Card:** Khách hàng nội thành có tần suất đi chơi thấp nhưng cực kỳ nhạy cảm với khuyến mãi. Voucher đã đánh trúng tâm lý, đẩy số chuyến đi tăng vọt (+0.91 chuyến - 2.5 chuyến tùy phân bổ), tạo ra mức Doanh thu thuần gia tăng dương kỷ lục.
...
2. **Thực thi Mở rộng (Roll-out):** Thiết lập chiến dịch Marketing tự động phát hành Voucher 15% độc quyền cho nhóm `Urban Credit Card` vào các khung giờ thấp điểm.
