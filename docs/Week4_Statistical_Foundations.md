...
|---|---|---|---|---|---|
| **Urban Cash (Đi làm)** | +0.84 | 0.042 | [0.03, 1.65] | **-28.7%** | ❌ **Dừng Voucher**. Hiệu ứng Cannibalization (Ăn mòn lợi nhuận). Họ vốn dĩ sẽ đi xe mà không cần mã. |
...
| **Urban Credit Card (Đi chơi nội thành)** | **+2.52** | **< 0.001** | **[1.85, 3.19]** | **+115%** | ✅ **Tăng ngân sách**. Cầu co giãn cực mạnh, Voucher thực sự kích cầu đi lại. |
...
> Nếu ta chỉ chạy A/B Test trên toàn bộ 20,000 user mà không phân cụm, **ATE trung bình chỉ ở mức +1.2 chuyến và ROI tổng có thể ÂM**. Nhờ việc kết hợp K-Means (Tuần 3) và bóc tách A/B Test theo nhóm (Tuần 4), ta mới phát hiện ra "Mỏ vàng" Urban Credit Card để tối ưu hóa chiến dịch.
