...
2. **Kiểm tra A/A Test (False Positive Check):**
   ...
   - **Kết quả:** Hệ thống báo cáo ATE xoay quanh 0 và P-value > 0.05, không bị đánh lừa (không ghi nhận false positive trong scenario này).
...
4. **Kiểm tra Bơm Nhiễu (Gaussian Noise Injection):**
   ...
   - **Kết quả:** ATE đo được có sai số không đáng kể. Cơ chế ngẫu nhiên hóa (Randomization) của A/B Test giúp cân bằng exogenous noise theo kỳ vọng, nhưng noise vẫn làm tăng uncertainty ở cả 2 nhóm.
